...
#SBATCH -o /scratch/larissasa/bradypus/09_Resequencing/11_snpEff/02_snpeff_maxmiss_0.8/jobs/snpEff.%j.out
#SBATCH -e /scratch/larissasa/bradypus/09_Resequencing/11_snpEff/02_snpeff_maxmiss_0.8/jobs/snpEff.%j.err
