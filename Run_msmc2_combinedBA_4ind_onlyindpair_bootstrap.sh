...
#SBATCH -o /scratch/larissasa/bradypus/09_Resequencing/08_msmc/msmc2.comb.4ind.onlyindpair.boot.%j.out
#SBATCH -e /scratch/larissasa/bradypus/09_Resequencing/08_msmc/msmc2.comb.4ind.onlyindpair.boot.%j.err
